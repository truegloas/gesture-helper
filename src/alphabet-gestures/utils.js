...
export function addDirection(gesture, finger, direction = 'Horizontal') {
    if (direction !== 'Horizontal') {
        ...
        gesture.addDirection(finger, fp.FingerDirection.nameMapping['Diagonal ' + direction + ' Left'], 0.5);
        gesture.addDirection(finger, fp.FingerDirection.nameMapping['Diagonal ' + direction + ' Right'], 0.5);
    } else {
